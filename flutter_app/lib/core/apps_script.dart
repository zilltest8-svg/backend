...
const defaultSheetId = '1GaCxdtWKt_IL-Fd3KH673DgpKiCobU-2MiyNAQYRtT4';

/// Pull the document id out of any Google Sheets URL.
String? sheetIdFrom(String url) =>
    RegExp(r'docs\.google\.com/spreadsheets/d/([a-zA-Z0-9-_]{20,})').firstMatch(url.trim())?.group(1);

String sheetUrlFrom(String id) => 'https://docs.google.com/spreadsheets/d/$id/edit';
...
String buildScript(String sheetId, [String tabName = 'Office Time']) =>
    '''/**
